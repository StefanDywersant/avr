...
void encrypt(void) {
	uint8_t payload[8] = {0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01};
	uint8_t i;


	rc2_encrypt(8, payload);
...
int main(void) {
	...
	rfproto_async_tx(4, payload, type);

	rfproto_rx(4, payload, &type);
